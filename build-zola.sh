...
TINYSEARCH_SHA256="9eb31d6450e4e1a88670c9c8bdc9a16b31827d712c7523dec791392d1a134cd1"
...
if [[ "$needs_tinysearch" == true ]]; then
    ...
    curl -fsSL \
        "https://github.com/tinysearch/tinysearch/releases/download/v${TINYSEARCH_VERSION}/tinysearch-v${TINYSEARCH_VERSION}-x86_64-unknown-linux-gnu.tar.gz" \
